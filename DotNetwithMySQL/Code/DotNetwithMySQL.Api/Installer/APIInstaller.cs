...
using ElmahCore.Mvc;
using ElmahCore;
using DotNetwithMySQL.Api.Filters;
using DotNetwithMySQL.Business.Installer;

namespace DotNetwithMySQL.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotNetwithMySQL API", Version = version + "-" + branch});
            });
