...
using ElmahCore.Mvc;
using ElmahCore;
using DotNetwithMSSQL.Api.Filters;
using DotNetwithMSSQL.Business.Installer;

namespace DotNetwithMSSQL.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotNetwithMSSQL API", Version = version + "-" + branch});
            });
