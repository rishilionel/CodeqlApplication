...
using ElmahCore.Mvc;
using ElmahCore;
using DotnetMongo.Api.Filters;
using DotnetMongo.Business.Installer;

namespace DotnetMongo.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetMongo API", Version = version + "-" + branch});
            });
